...
async function loadContract() {
    // set ABI
    var abi = [{"inputs":[{"internalType":"string","name":"fileHash","type":"string"}],"name":"fileUploader","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"fileHash","type":"string"}],"name":"isFileDownloadable","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"index","type":"uint256"}],"name":"myDelegatedFile","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"myDelegatedFilesLength","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"index","type":"uint256"}],"name":"myFile","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"fileHash","type":"string"},{"internalType":"uint256","name":"index","type":"uint256"}],"name":"myFileDelegate","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"fileHash","type":"string"}],"name":"myFileDelegatesLength","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"fileHash","type":"string"}],"name":"myFileName","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"myFilesLength","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"fileHash","type":"string"},{"internalType":"string","name":"fileName","type":"string"},{"internalType":"address[]","name":"delegates","type":"address[]"},{"internalType":"uint256","name":"dTime","type":"uint256"}],"name":"uploadFile","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"nonpayable","type":"function"}];
...
fileForm.addEventListener('submit', async function (event){
    ...
    const result = await window.contract.methods.uploadFile(fileHash.path, inpFileName, delegates, dTime).send({ from: account });
    if(result){
...
function getMyFiles(){
    ...
    window.contract.methods.myFilesLength().call({from: window.contract.defaultAccount}).then(function(myFilesLen){
        console.log(myFilesLen);
        for(var i=0; i < myFilesLen; i++){
            window.contract.methods.myFile(i).call({from: window.contract.defaultAccount}).then(function(myFileHash){
                console.log(myFileHash);
                window.contract.methods.myFileName(myFileHash).call({from: window.contract.defaultAccount}).then(function(myFName){
                    myFilesTag += "<p>" + myFName + "</p>";
                });

                window.contract.methods.myFileDelegatesLength(myFileHash).call({from: window.contract.defaultAccount}).then(function(myFileDelegatesLen){
                    myFilesTag += "<ul>";
                    console.log(myFileDelegatesLen);
                    for(var j=0; j < myFileDelegatesLen; j++){
                        window.contract.methods.myFileDelegate(myFileHash, j).call({from: window.contract.defaultAccount}).then(function(myFDelegate){
    ...
    window.contract.methods.myDelegatedFilesLength().call({from: window.contract.defaultAccount}).then(function(myDelegatedFiles){
        console.log(myDelegatedFiles);
        for(var k=0; k < myDelegatedFiles; k++){
            window.contract.methods.myDelegatedFile(k).call({from: window.contract.defaultAccount}).then(function(myDelegatedF){
                window.contract.methods.myFileName(myDelegatedF).call({from: window.contract.defaultAccount}).then(function(delegatedFN){
                    window.contract.methods.fileUploader(myDelegatedF).call({from: window.contract.defaultAccount}).then(function(fileUploader){
